...
### To try the Web UI for your image, follow these steps:-

1. Run following commands
````bash
    (animated_drawings) examples % cd web-UI
    (animated_drawings) web-UI  % python app.py
    ...
...
````
2. On UI ,Upload your image (i.e, image_name).

    image will be processing ... this takes a while (~2-3 minutes)

3. Once the image is processed, the resulting animated drawing will be saved in the video.gif folder located at: AnimatedDrawings-main\examples\{image_name}\video.gif
